...
# Settings are in smart_check/settings/, so we need .parent.parent.parent
...
# Email settings moved to local.py and production.py
# Each environment defines its own EMAIL_BACKEND
...
# Each environment defines its own DATABASES setting
